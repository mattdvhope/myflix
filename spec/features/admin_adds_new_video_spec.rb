...
feature 'Admin adds new video' do
  scenario 'Admin successfully adds a new video' do
    ...
    expect(page).to have_selector("img[src='/uploads/amazon_large.png']") # the large cover / Find this correct 'src=' format by doing 'Inspect Element' on the large_cover on this page in the browser.
